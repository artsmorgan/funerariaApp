...
?>
<?php if(  !empty($row) ) : ?>
    <?php echo form_open(site_url('servicio/servicios/newAmountDiscount'), array('class' => 'services form-horizontal form-groups-bordered form-fun validate', 'enctype' => 'multipart/form-data')); ?>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" data-info="concepto" name="concepto" class="form-control" value="APLICAR DESCUENTO" />
                                </div>
                            </div>
                        </div>
