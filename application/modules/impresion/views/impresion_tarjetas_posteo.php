...
s.amount, c.email, CONCAT( u.first_name, ' ', u.last_name ) AS seller_name,
...
<div class="print_container">
    <div class="page_print">
        ...
        <p class="print_interes"><strong>Interés: </strong> <span>TBP</span></p>
        <p class="print_contract_id"><strong>N Contrato: </strong> <span></span></p>
        <p class="print_seller_name"><strong>Vendedor: </strong> <span></span></p>
        ...
        <p class="print_email"><strong>Email: </strong> <span></span></p>
...
<script>
    $(function(){
        ...
        $('#table_export').on('click', '.btn', function(e){
            ...
            $print_container.find('.print_seller_name span').text(seller_name);
            $print_container.find('.print_email span').text(email);
