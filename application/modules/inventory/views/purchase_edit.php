...
foreach($edit_data as $row) { ?>
    ...
    <ol class="breadcrumb bc-3 pull-left" style="margin-bottom: 0px;">
        ...
        <li class="active"><?php echo lang_key('edit_purchase'); ?></li>
    </ol>
    <br><br>
    <?php echo form_open(site_url('inventory/purchase/update/' . $purchase_id), array('class' => 'form-horizontal',
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="purchase_code" readonly
                                        value="<?php echo $row['purchase_code']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="supplier_id" class="selectboxit" required>
                                        ...
                                        foreach($suppliers as $row2) { ?>
                                            <option value="<?php echo $row2['contact_id'] ?>"
                                                <?php if($row2['contact_id'] == $row['supplier_id']) echo 'selected'; ?>>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        <select onchange="return get_product_for_purchase(this.value)" class="selectboxit" name="product_id" required>
                                        ...
                                        <tbody id="purchase_entry_holder">
                                            ...
                                            foreach($purchase_items as $row2) {
                                                ...
                                                <tr id="entry_row_<?php echo $total_number; ?>">
                                                    ...
                                                    <td>
                                                        <input type="number" name="purchase_price[]" class="form-control" value="<?php echo $row2['purchase_price']; ?>" min="1"
                                                               id="single_entry_purchase_price_<?php echo $total_number; ?>"
                                                               onkeyup="calculate_single_entry_sum(<?php echo $total_number; ?>)"
                                                               onclick="calculate_single_entry_sum(<?php echo $total_number; ?>)">
                                                    </td>
            ...
            <div class="form-group">
                <div class="col-md-6 col-md-offset-5">
                    <button type="submit" class="btn btn-info">
                        <?php echo lang_key('update_purchase'); ?>
                    </button>
                </div>
            </div>
    <?php echo form_close();
...
<script type="text/javascript">
    ...
    var total_number = <?php echo $this->db->get_where('purchase_item', array('purchase_id' => $purchase_id))->num_rows(); ?>;
