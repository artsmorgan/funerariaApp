                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12">
                                    <select onchange="return get_product_for_sale(this.value)" class="form-control selectboxit" name="product_id" required>
                        ...
                        <div class="col-md-9">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="sale_entry_holder"></tbody>
                                </table>
                            </div>
                        </div>
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-5">
                <button type="submit" class="btn btn-info">
                    <?php echo lang_key('create_new_sale'); ?>
                </button>
            </div>
        </div>
<?php echo form_close(); ?>
