<a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('admin/modal/popup/inventory/product_category_add'); ?>')" 
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                <li>
                                    <a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('admin/modal/popup/inventory/product_category_edit/' . $row['product_category_id']); ?>');">
                                ...
                                <li class="divider"></li>
                                <li>
                                    <a href="#" onclick="confirm_modal('<?php echo site_url('inventory/product_category/delete/' . $row['product_category_id']); ?>');">
