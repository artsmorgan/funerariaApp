<?php
$edit_data = $this->db->get_where('income', array('income_id' => $param3))->result_array();
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <?php echo lang_key('edit_income'); ?>
                    </div>
                </div>

                <div class="panel-body">

                    <?php echo form_open(site_url('income_expense/income/update/' . $param3), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
