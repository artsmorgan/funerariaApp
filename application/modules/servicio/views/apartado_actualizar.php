<?php 
$sql = "SELECT s.*, u.user_id AS seller_id, CONCAT( u.first_name, ' ', u.last_name ) AS seller_name, a.monto_total
FROM bk_service AS s 
INNER JOIN bk_user AS u ON s.user_id = u.user_id 
INNER JOIN bk_apartados_account AS a ON a.service_id = s.service_id
WHERE s.service_id = ?";
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="abono" id="abono" value="<?php echo $row['abono']; ?>">
                </div>
                <!-- fith row -->
...
<script>
   ...
   $('#advance_payment,#plazo').closest('.row').remove();
    $('#debt').closest('.col-md-12').remove();
