        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="phone2" disabled />
                            </div>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="phone3" disabled />
                            </div>
                        </div>
                    </div>
                    <!-- col -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="address" class="form-control" rows="1" disabled></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="field-3" class="col-sm-12 control-label">Autopcia</label>
                            <div class="col-sm-3">
                                <input type="checkbox" name="" class="form-control" value="1">
                            </div>
                            <div class="col-sm-9">
