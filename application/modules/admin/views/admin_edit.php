...
$uid = $_REQUEST['user'] ;
$sql = "select * from bk_user where user_id= ?";
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/admins/update_admin/'.$uid), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
