...
<button onClick="copy_language()">copy</button>
                        ...
                        $count = 1;
                        $language_phrases   =   $this->db->query("SELECT `phrase_id` , `phrase` , `$current_editing_language` FROM `bk_language`")->result_array();
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/manage_language/edit_phrase/'.$field);?>"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo lang_key('edit_phrase');?>" class="btn btn-blue">
                    ...
                    <?php echo form_open(base_url().'index.php/admin/manage_language/add_phrase/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo lang_key('phrase');?></label>
                                <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo lang_key('add_phrase');?></button>
                        </div>
                    <?php echo form_close();?>                
                </div>                
            </div>
            ...
            <div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().'index.php/admin/manage_language/add_language/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo lang_key('language');?></label>
                                <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo lang_key('add_language');?></button>
                        </div>
                    <?php echo form_close();?>
                </div>
            </div>
