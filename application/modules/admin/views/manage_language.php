            ...
            <?php if (isset($edit_profile)): ?>
                <li class="active">
                    <a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
                        <?php echo lang_key('edit_phrase'); ?>
                    </a></li>
            <?php endif; ?>
            <li class="<?php if (!isset($edit_profile)) echo 'active'; ?>">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
                    <?php echo lang_key('language_list'); ?>
                </a></li>
            <li>
                <a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
                    <?php echo lang_key('add_phrase'); ?>
                </a></li>
            <li class="">
                <a href="#add_lang" data-toggle="tab"><i class="entypo-plus-circled"></i> 
                    <?php echo lang_key('add_language'); ?>
                </a></li>
        </ul>
        <!------CONTROL TABS END------>
        ...
        <div class="tab-content">
                ...
                <div class="tab-pane active" id="edit" style="padding: 5px">
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            $count = 1;
                            $select_text= 'phrase_id, phrase,'.$current_editing_language; 
                            $this->db->select($select_text);
                            $language_phrases =  $this->db->get('language')->result_array();
                        ...
                        <input type="submit" value="<?php echo lang_key('update_phrase'); ?>" onClick="document.getElementById('phrase_form').submit();" class="btn btn-blue"/>	
                        <?php
                        echo form_close();
                        ?>
            ...
            <div class="tab-pane <?php if (!isset($edit_profile)) echo 'active'; ?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
                    <thead>
                        <tr>
                            <th><?php echo lang_key('language'); ?></th>
                            <th><?php echo lang_key('option'); ?></th>
                        ...
                        foreach ($fields as $field) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo site_url('admin/dump_language_file/' . $field); ?>"
                                       class="btn btn-info">
                                           <?php echo lang_key('write_language_file'); ?>
                                    </a>
                                    <a href="<?php echo site_url('admin/manage_language/delete_language/' . $field); ?>"
                                       rel="tooltip" data-placement="top" data-original-title="<?php echo lang_key('delete_language'); ?>" class="btn btn-gray" onclick="return confirm('Delete Language ?');">
                ...
                <div class="box-content">
                    ...
                    <div class="padded">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo lang_key('phrase'); ?></label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="phrase" data-validate="required" data-message-required="<?php echo lang_key('value_required'); ?>"/>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo lang_key('add_phrase'); ?></button>
                        </div>
                    </div>
                    <?php echo form_close(); ?>                
                </div>                
                ...
                <div class="box-content">
                    ...
                    <div class="padded">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="language" data-validate="required" data-message-required="<?php echo lang_key('value_required'); ?>"/>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo lang_key('add_language'); ?></button>
                        </div>
                    </div>
                    <?php echo form_close(); ?> 
                </div>
